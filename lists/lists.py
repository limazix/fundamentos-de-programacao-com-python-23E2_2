...
def nome_no_formulario(entrada: str) -> str:
    """ TP 3.11 - Dada uma linha de texto, indicar se ele cabe ou não cabe em um campo de formulário com 80 caracteres."""

    if type(entrada) != str:
        raise ValueError("A entrada deveria ser uma string!!!")
